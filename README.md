...
```
$ git clone git@github.com:atomist/npm-automations.git
$ cd npm-automations
$ npm install
```
...
[hello]: https://github.com/atomist/npm-automations/blob/master/src/commands/simple/HelloWorld.ts (HelloWorld Command Handler)
...
[issue-handler]: https://github.com/atomist/npm-automations/blob/master/src/events/CommentOnIssue.ts (CommentOnIssue Event Handler)
...
[issue]: https://github.com/atomist/npm-automations/issues
